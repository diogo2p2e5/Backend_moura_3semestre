...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__BCC70973C4C87BF8");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__CFB2F0298429F5A1");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__6C4272E624809E07");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__622D85AB75F27991");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__EF59F762D9D356C2");

            entity.Property(e => e.IdUsuario).HasDefaultValueSql("(newid())");

            entity.HasOne(d => d.IdTipoUsuarioNavigation).WithMany(p => p.Usuarios).HasConstraintName("FK__Usuario__Id_Tipo__68487DD7");
        });
